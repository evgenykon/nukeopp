...
//     );
//     expect(Math.round(calc.getNextStepCoordinates().latitude * 1000)).toBe(6);
//     expect(calc.getNextStepCoordinates().longitude).toBe(0);
// });
...
//     );
//     expect(Math.round(calc.getNextStepCoordinates().longitude * 1000)).toBe(6);
// });
